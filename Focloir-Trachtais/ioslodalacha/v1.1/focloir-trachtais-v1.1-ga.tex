...
\textbf{dlúth (ainmfhocal): density}
...
\textbf{frith-shampla (ainmfhocal): negative (sample)}
...
\textbf{leagan (ainmfhocal): instantiation (concept)}
...
\textbf{meastachán (ainmfhocal): estimate}
...
\textbf{meastachán a dhéanamh (ar) (ainmfhocal): to approximate}
...
\textbf{réamh-thraenáil (ainmfhocal): pretraining}
...
\textbf{teisteáil (ainmfhocal): testing}
...
\textbf{tomhas (ainmfhocal): metric}
...
\textbf{traenáil (ainmfhocal): training}
